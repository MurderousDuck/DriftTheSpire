...
@SpireInitializer
public class DriftTheSpire implements
    ...
    private static final String resourcesFolder = "driftthespire";
    ...
    private static final Color cardColor = new Color(192f/255f, 192f/255f, 192f/255f, 1f);
    private static final String CHAR_SELECT_BUTTON = characterPath("select/button2.png");
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(TheAutomobile.Enums.CARD_COLOR, cardColor, BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB, BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P, SMALL_ORB);
    }

    public DriftTheSpire() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(DriftTheSpire.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheAutomobile(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, TheAutomobile.Enums.THE_AUTOMOBILE);
    }

    @Override
    public void receiveAddAudio() {
        BaseMod.addAudio("BEEP_BEEP", characterPath("beepbeep.mp3"));
    }
    ...
    public void receiveOnBattleStart(AbstractRoom abstractRoom) {
        CharacterUtils.currentGear = 0;
        CharacterVariables.EXTRA_SPEED_INCREMENT = 0;
    }
}
