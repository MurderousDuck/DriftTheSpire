...
import driftthespire.cards.attacks.AggressiveTurn;
import driftthespire.cards.attacks.StrikeCar;
import driftthespire.cards.skills.DefendCar;
import driftthespire.cards.skills.StepOn;
import driftthespire.relics.DustyMeter;
import driftthespire.relics.OldEngine;

import java.util.ArrayList;

import static driftthespire.DriftTheSpire.characterPath;
import static driftthespire.DriftTheSpire.makeID;

public class TheAutomobile extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheAutomobile"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_AUTOMOBILE;
        @SpireEnum(name = "CAR_SILVER_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CAR_SILVER_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheAutomobile() {
        super(NAMES[0], Enums.THE_AUTOMOBILE,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(StrikeCar.ID);
        retVal.add(StrikeCar.ID);
        retVal.add(StrikeCar.ID);
        retVal.add(StrikeCar.ID);
        retVal.add(StrikeCar.ID);
        retVal.add(DefendCar.ID);
        retVal.add(DefendCar.ID);
        retVal.add(DefendCar.ID);
        retVal.add(DefendCar.ID);
        retVal.add(AggressiveTurn.ID);
        retVal.add(StepOn.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(DustyMeter.ID);
        retVal.add(OldEngine.ID);
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA("BEEP_BEEP", 0.1F); //MathUtils.random(-0.2F, 0.2F));
