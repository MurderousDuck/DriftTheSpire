...
public class ShiftDownOption extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "DownGear", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void onChoseThisOption() {
        CharacterUtils.decreaseGear();
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new ShiftDownOption();
    }
}
