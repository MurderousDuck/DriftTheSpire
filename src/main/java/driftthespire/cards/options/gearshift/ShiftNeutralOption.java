...
public class ShiftNeutralOption extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "NeutralGear", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void onChoseThisOption() {
        CharacterUtils.neutral();
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new ShiftNeutralOption();
    }
}
