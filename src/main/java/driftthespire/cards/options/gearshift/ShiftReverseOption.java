...
public class ShiftReverseOption extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "ReverseGear", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void onChoseThisOption() {
        CharacterUtils.reverse();
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new ShiftReverseOption();
    }
}
