package driftthespire.cards.options.stepon;
...
public class SlowdownOption extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "SlowdownOption", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ReducePowerAction(p, p, SpeedPower.POWER_ID, magicNumber * BASE_SPEED_INCREMENT));
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new SlowdownOption();
    }
}
